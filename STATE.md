...
- ✅ **DEPLOYED = `25e8edd` (2026-09-11)** — v4.7.0 still, and read back from the
  VM's own HEAD, not retyped. `<== exit 0 — ran to the end` + `DEPLOY_EXIT=0`.
  Six deploys today; this one carries the docs REDACTION, verified in the
