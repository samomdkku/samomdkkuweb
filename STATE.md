...
- **Migrations through 0199. ALL 48 LIVE PROOFS GREEN** (2026-09-14; 0195–0198 added and the Discord proofs re-run 2026-09-19; 0199 shop per-size pricing + server-side price, `shop0199-pricing` 20/20 on dev AND production 2026-09-21) — what each one changed and which hole it closed is `docs/state-archive/2026-09-19-state-prune.md`; the proofs themselves are the authority. ⛔ Ask `npm run migrate:status`, never this line.
